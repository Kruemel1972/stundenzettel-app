    ...
    <main style={pageStyle}>
      <div style={wrapStyle}>
        <div style={{ ...cardStyle, marginBottom: 18 }}>
          <h1 style={{ margin: "0 0 16px 0", fontSize: 30 }}>Admin – Stammdaten</h1>
            ...
            <>
              ...
              >
                <input
                  ...
                  style={inputStyle}
                />
                <button onClick={addActivity} style={buttonStyle} disabled={saving}>
                  Hinzufügen
                </button>
              </div>
            ...
            <>
              ...
              >
                <input
                  ...
                  style={inputStyle}
                />
                <button onClick={addLocation} style={buttonStyle} disabled={saving}>
                  Hinzufügen
                </button>
              </div>
            ...
            <>
              ...
              >
                ...
                <input
                  ...
                  style={inputStyle}
                />
                <button onClick={addTractor} style={buttonStyle} disabled={saving}>
                  Hinzufügen
                </button>
              </div>
            ...
            <>
              ...
              >
                ...
                <input
                  ...
                  style={inputStyle}
                />
                <button onClick={addImplement} style={buttonStyle} disabled={saving}>
                  Hinzufügen
                </button>
              </div>
